...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\edsoa\Documents\python_sqlAchemy\.venv'
    let bin = 'Scripts'
    let path_sep = ';'
    ...
    let virtual_prompt = if ('python-sqlachemy-py3.11' == '') {
        $'(char lparen)($virtual_env | path basename)(char rparen) '
    } else {
        '(python-sqlachemy-py3.11) '
    }
...
alias deactivate = source 'C:\Users\edsoa\Documents\python_sqlAchemy\.venv\Scripts\deactivate.nu'
